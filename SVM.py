...
def get_args():
    ...
    parser.add_argument('--path', type=str, default=r"D:\dataset")
    parser.add_argument('--out', type=str, default=r"D:\dataset")
...
def main():
    ...
    df = pd.read_csv(os.path.join(args.path, r"D:\dataset\merged.csv"))  # data_concat_non_normaliz
    ...
    file_csv.to_csv(os.path.join(args.out, 'data_pred_normaliz.csv'), index=False)
    print("save file csv")
    print(y_pred_test)
    ...
    filename = os.path.join(args.out, 'data_pred_normaliz.csv')
    pickle.dump(svc_rbf_c100, open(filename, 'wb'))
    print('save model')
...
if __name__ == '__main__':
    ...
    def plot_confusion_matrix(cm,
        ...
        plot_confusion_matrix(cm1,
                          ["Calc", "Mass"],  # use y_train.unique()  to know order of labels
