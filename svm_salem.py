...
def get_args():
    ...
    parser.add_argument('--path', type=str, default = '../input/data-csv')
    parser.add_argument('--out', type=str, default = 'final_svm')
...
#data = '/kaggle/input/predicting-a-pulsar-star/pulsar_stars.csv'
    ...
    print(svc_hyperpar.predict([[0.631782889,	0.570873787,	0.802025494,	0.849797332,	0.518862585,	0.060393748,	0.560680091,	0.896131279]]))
    print(svc_hyperpar.predict([[0.666798273,	0.592289976,	0.703626803,	0.866931571,	0.631824248,	0.112674902,	0.240149013,	0.887604622]]))
    print(svc_hyperpar.predict([[0.658594558,	0.732025947,	0.635631521,	0.94480272,	0.795775904,	0.432548706,,	0.151517162,	0.904033941]]))
