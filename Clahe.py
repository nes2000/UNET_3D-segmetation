...
def get_args():
    ...
    parser.add_argument('--path_img',type=str,default=r"C:\Users\clt\Documents\projet\filter\Nouveau dossier")
    # arguments for training
    parser.add_argument('--out', type=str, default=r"C:\Users\clt\Documents\projet\filter\images")
