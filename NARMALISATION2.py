...
def get_args():
    ...
    parser.add_argument('--path_data',type=str,default='../input/data-csv')
    parser.add_argument('--path_target', type=str, default='../input/datasetcropedtargetversion2/dataset')
    parser.add_argument('--out', type=str, default='data_norm')
